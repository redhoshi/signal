...
import { Card, CardBody, CardFooter, Box, Flex, Text, Avatar, Heading, Stack, Divider, ButtonGroup, IconButton, Image, Button,Tag,
  TagLabel,
  TagLeftIcon,
  TagRightIcon,
  TagCloseButton, HStack} from "@chakra-ui/react";
import { FaQuestionCircle } from "react-icons/fa";
import { BsPersonCircle } from "react-icons/bs";

const Skills = () => {
  return (
    <div id="Skills" style={{ height: "1300px", padding: "5%" }}>
